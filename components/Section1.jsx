    ...
    return (
        <section className={styles.section}>
            ...
            <div className={styles.cards}>
                ...
                <div>
                    <div>
                        <ProductCard href={"#"} thumbnail={"/AIWC80_oak.png"} name={"Dostawka do szafki"} />
                    </div>
                    <div>
                        <ProductCard href={"#"} thumbnail={"/AIM35.png"} name={"Szafka podumywalkowa"} />
                    </div>
                </div>
                <div>
                    <div className={styles.card}>
                        <img src="/card_background.png" alt="background" />
                        <div>
